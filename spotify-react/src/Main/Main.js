        ...
        <div className="offer__scroll-container">
          <div className="offer__list">
            <section className="offer__list-item">
              <a href="Boas festas" className="cards">
                <div className="cards card1">
                  <img src={Playlist1} alt="" />
                  <span>Boas festas</span>
                </div>
              </a>
              <a href="Feitos para você" className="cards">
                <div className="cards card2">
                  <img src={Playlist2} alt="" />
                  <span>Feitos para você</span>
                </div>
              </a>
              <a href="Lançamentos" className="cards">
                <div className="cards card3">
                  <img src={Playlist3} alt="" />
                  <span>Lançamentos</span>
                </div>
              </a>
              <a href="Creators" className="cards">
                <div className="cards card4">
                  <img src={Playlist4} alt="" />
                  <span>Creators</span>
                </div>
              </a>
              <a href="Para treinar" className="cards">
                <div className="cards card5">
                  <img src={Playlist5} alt="" />
                  <span>Para treinar</span>
                </div>
              </a>
              <a href="Podcasts" className="cards">
                <div className="cards card6">
                  <img src={Playlist6} alt="" />
                  <span>Podcasts</span>
                </div>
              </a>
              <a href="Sertanejo" className="cards">
                <div className="cards card7">
                  <img src={Playlist7} alt="" />
                  <span>Sertanejo</span>
                </div>
              </a>
              <a href="Samba e pagode" className="cards">
                <div className="cards card8">
                  <img src={Playlist8} alt="" />
                  <span>Samba e pagode</span>
                </div>
              </a>
              <a href="Funk" className="cards">
                <div className="cards card9">
                  <img src={Playlist9} alt="" />
                  <span>Funk</span>
                </div>
              </a>
              <a href="MPB" className="cards">
                <div className="cards card10">
                  <img src={Playlist10} alt="" />
                  <span>MPB</span>
                </div>
              </a>
              <a href="Rock" className="cards">
                <div className="cards card11">
                  <img src={Playlist11} alt="" />
                  <span>Rock</span>
                </div>
              </a>
              <a href="Hip Hop" className="cards">
                <div className="cards card12">
                  <img src={Playlist12} alt="" />
                  <span>Hip Hop</span>
                </div>
              </a>
              <a href="Indie" className="cards">
                <div className="cards card13">
                  <img src={Playlist13} alt="" />
                  <span>Indie</span>
                </div>
              </a>
              <a href="Relax" className="cards">
                <div className="cards card14">
                  <img src={Playlist14} alt="" />
                  <span>Relax</span>
                </div>
              </a>
              <a href="Música Latina" className="cards">
        ...
        <div className="grid-container">
          <div className="artist-card" id="">
            ...
            <div className="card-text">
              <a title="Foo Fighters" className="vst" href="Artista-imagem">
